...
export const COMPANY_TEAM = [{
    name: "John Doe",
    role: "Founder & CEO",
    bio: "John has over 15 years of experience in the automotive industry and is committed to revolutionizing the car buying experience.",
    imageUrl: "https://i.pravatar.cc/300",
}, {
    name: "Jane Smith",
    role: "Chief Technology Officer",
    bio: "Jane leads our tech team with a focus on innovation and user-centric design, ensuring our platform is both reliable and easy to use.",
    imageUrl: "https://i.pravatar.cc/300",
}]
